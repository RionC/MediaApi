    ...
    public class MediaDataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MediaItem>().HasData(
                new MediaItem { Id = 1, Title = "Super Mario Kart", Consumed = false, Kind = "game", RecommendedBy = "John", Removed = false },
                new MediaItem { Id = 2, Title = "Riverdale", Consumed = true, Kind = "show", RecommendedBy = "Marissa", DateConsumed = DateTime.Now.AddDays(-14), Removed = false }
                ) ;
        }
    }
}
